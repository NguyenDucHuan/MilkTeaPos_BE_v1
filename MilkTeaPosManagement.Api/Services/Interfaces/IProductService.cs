...
namespace MilkTeaPosManagement.Api.Services.Interfaces
{
    ...
    {
        Task<MethodResult<List<Product>>> CreateProductWithSizesAsync(int userId, CreateProductParentRequest parentRequest, List<ProductSizeRequest> sizes, List<ToppingForCreate> toppings);
        ...
        Task<MethodResult<ProductResponse>> UpdateMasterProductAsync(int userId, UpdateMasterProductRequest request, List<UpdateSizeProductRequest> Variants, List<UpdateToppingProductRequest> toppings);
